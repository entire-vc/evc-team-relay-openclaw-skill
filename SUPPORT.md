...
Thanks for using the EVC Team Relay skill for OpenClaw. This page is the whole map: where to go, and what happens after you write.

## Where to go

| What you have | Where to put it | First response |
|---|---|---|
| A bug | [Open an issue](https://github.com/entire-vc/evc-team-relay-openclaw-skill/issues/new/choose) | 2 business days |
| A feature idea | [Open an issue](https://github.com/entire-vc/evc-team-relay-openclaw-skill/issues/new/choose) | 2 business days |
| A setup or usage question | [Open an issue](https://github.com/entire-vc/evc-team-relay-openclaw-skill/issues/new/choose), or email <support@entire.vc> | 2 business days |
...
| A security vulnerability | **Not a public issue.** [Report it privately](https://github.com/entire-vc/evc-team-relay-openclaw-skill/security/advisories/new) | 48 hours |
